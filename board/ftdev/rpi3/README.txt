...
1 ftdev_rpi3_minimal_defconfig : Ready to add Qt packages but not added so you can configure Qt by
"make xconfig" according to your application's needs.
2 ftdev_rpi3_qt_defconfig : Qt packages are added. This can run QML application and get
data from UART.
3 ftdev_rpi3_fastboot_defconfig : System be booted in 1.2seconds. You can put your statically-compiled
Qt application in it so it'll directly run.
